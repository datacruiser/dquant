...
_SUBMODULES = {
    ...
    "QMTBroker": "dquant.broker.qmt_broker:QMTBroker",
    "QMTSimulator": "dquant.broker.qmt_broker:QMTSimulator",
    "XTPBroker": "dquant.broker.xtp_broker:XTPBroker",
    "XTPSimulator": "dquant.broker.xtp_broker:XTPSimulator",
    ...
    "LiveTradingConfig": "dquant.config:LiveTradingConfig",
    "XTPBrokerConfig": "dquant.config:XTPBrokerConfig",
