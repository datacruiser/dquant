...
def _make_order(**overrides):
    defaults = dict(
        symbol='000001.SZ', side='BUY', quantity=100, price=10.0, order_type='LIMIT',
    )
...
def _make_result(**overrides):
    defaults = dict(
        order_id='test-001', symbol='000001.SZ', side='BUY',
        filled_quantity=100, filled_price=10.0, commission=3.0,
